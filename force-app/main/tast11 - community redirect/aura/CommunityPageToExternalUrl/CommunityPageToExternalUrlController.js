({
	doInit : function(component, event, helper) {
        ...
        if (loadInExistingWindow && window.location.href.indexOf("live-preview") == -1) { // 2023-12-12 updated by aykut.parlak@sbdinc.com
            ...
            if (window.location.href.indexOf("live-preview") == -1) { // 2023-12-12 updated by aykut.parlak@sbdinc.com
                window.history.back();
            }
        }
	}
